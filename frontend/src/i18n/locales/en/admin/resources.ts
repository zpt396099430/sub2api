export default {
    ...
    proxies: {
      ...
      batchInputHint:
        "Mixed input is supported: host:port:user:pass, user:pass{'@'}host:port, user:pass:host:port, and scheme URLs. Bare entries use the selected protocol above.",
  ...
  globalPricing: {
      ...
      description: 'Matched models are billed at these prices across all groups and accounts; unset models keep their original pricing. Changes take effect within 60 seconds.',
      addPricing: 'Add Pricing',
      editPricing: 'Edit Pricing',
      deletePricing: 'Delete Pricing',
      modelPattern: 'Model',
      modelPatternPlaceholder: 'e.g. gpt-5 or gpt-5*',
      modelPatternHint: 'Exact name (case-insensitive) or a single trailing * wildcard.',
      billingMode: 'Billing mode',
      inputPrice: 'Input / 1M tokens',
      outputPrice: 'Output / 1M tokens',
      cacheReadPrice: 'Cache read / 1M',
      cacheWritePrice: 'Cache write 5m / 1M',
      cacheWrite1hPrice: 'Cache write 1h / 1M',
      perRequestPrice: 'Per request',
      enabled: 'Enabled',
      source: 'Effective source',
      sourceGlobal: 'Global override',
      noPricing: 'No global pricing yet. Matched models will use this price everywhere.',
      confirmDelete: 'Delete this override? The model will fall back to its original pricing.',
  ...
  margin: {
      ...
      reasonLowMargin: "Margin rate below threshold",
      reasonCooldown: "Cooldown elapsed, probing",
      reasonManual: "Manually restored",
      title: 'Margin Center',
      description: 'Revenue is what users actually paid; cost is estimated from directory prices. Loss-making channels are fused automatically.',
      channel: 'Channel',
      model: 'Model',
      requests: 'Requests',
      revenue: 'Revenue',
      ...
      unfuse: 'Recover',
      unfuseSuccess: 'Channel recovered',
      events: 'Fuse events',
      fuseSettings: 'Fuse settings',
      enableFuse: 'Auto fuse loss-making channels',
      windowHours: 'Window (hours)',
      minSpend: 'Min est. spend ($)',
      minMarginRate: 'Fuse below margin rate',
      cooldownHours: 'Cooldown (hours)',
      intervalMinutes: 'Check interval (minutes)',
      fuseHint: 'Only channels with enough estimated spend are evaluated. Fused channels recover automatically after cooldown.',
      noData: 'No billable traffic in this window yet.',
      loadFailed: 'Failed to load margin data',
      saveFailed: 'Failed to save',
      saveSuccess: 'Saved successfully',
    },
  ...
  tieredRouting: {
      ...
      description: 'Premium users prefer premium-pool accounts; everyone else uses all accounts. Mark accounts in the account editor.',
      enable: 'Enable tiered routing',
      premiumUserIds: 'Premium user IDs',
      premiumUserIdsPlaceholder: 'e.g. 12, 34, 56',
      premiumUserIdsHint: 'Comma/space separated user IDs. These users always route premium.',
      minBalance: 'Min balance for premium ($)',
      minBalanceHint: 'Users with balance at or above this are premium. 0 disables the balance rule.',
      poolHint: 'Set an account pool to premium in the account editor (proxy section). Unmatched premium users fall back to all accounts.',
      loadFailed: 'Failed to load tiered routing settings',
      saveFailed: 'Failed to save tiered routing settings',
      saveSuccess: 'Tiered routing settings saved',
      invalidBalance: 'Min balance must be a non-negative number',
    },

  spendGuard: {
      reasonTokenRate: "Token consumption rate exceeds threshold",
      reasonErrorRate: "Error rate exceeds threshold",
      reasonManual: "Manually unfrozen",
      title: 'Spend Guard',
      description: 'Keys with abnormal token velocity or error rates are frozen automatically. Unfreeze manually after review.',
      settings: 'Protection rules',
      enableAuto: 'Auto freeze abnormal keys',
      windowMinutes: 'Window (minutes)',
      tokensPerMinute: 'Freeze above tokens/min',
      minRequests: 'Min requests',
      maxErrorRate: 'Freeze above error rate (0-1)',
      intervalSeconds: 'Check interval (seconds)',
      settingsHint: 'Keys below the minimum request count are never frozen. Frozen keys stay disabled until you unfreeze them.',
      key: 'API key',
      requests: 'Requests',
      ...
      unfreezeFailed: 'Failed to unfreeze key',
      events: 'Freeze events',
      noData: 'No key activity in this window yet.',
